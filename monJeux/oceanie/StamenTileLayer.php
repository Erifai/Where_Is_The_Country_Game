<?php
include_once('oceanie.php');
$rows = mysqli_fetch_assoc($result);
$score = (isset($_GET['sc']) ? intval($_GET['sc']) : 0); //remise à zero du score quand c'est une nouvelle partie
	...
	<body>
		<div id="maDiv"  style="width: 1200px ; height: 450px;  display: block; margin-left: auto; margin-right: auto; position: absolute; transform: translate(-50%, -50%);top: 40%; left: 50%"></div>
		    ...
		    <script>   
			 ...
			 var id_pays = sessionStorage.getItem("idPays");
				...
				<?php 
 				 	 if ($id_pays > 230 )  // fin de la partie
						 { 
		                    $id_pays=224; ?>
						    id_pays=0;
				            MonScore=0;
		...
		<script>
			...
			var map = new L.Map('maDiv', {
				center: [-16.959163074498438, 147.18146404853945],
				minZoom: 2,
				maxZoom: 18,
